            ...
            child: filtered.isEmpty
                ? Center(
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 16.0),
                      child: Text(
                        'No encontramos roles con esa búsqueda.',
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            gradient: _selected == role
                                ...
                                : null,
                            color: _selected == role ? null : scheme.surfaceBright,
                            borderRadius: BorderRadius.circular(24),
                            border: Border.all(
                            ...
                            children: [
                              AnimatedContainer(
                                ...
                                child: Icon(
                                  ...
                                  color: _selected == role ? Colors.white : scheme.primary,
                                  size: 20,
                                ),
                              ),
                              ...
                              Expanded(
                                child: AnimatedDefaultTextStyle(
                                  duration: const Duration(milliseconds: 300),
                                  style: Theme.of(context).textTheme.titleMedium!.copyWith(
                                        fontWeight: _selected == role ? FontWeight.bold : FontWeight.w600,
                                        color: _selected == role ? scheme.onPrimary : scheme.onSurface,
                                        fontSize: 16,
                                      ),
