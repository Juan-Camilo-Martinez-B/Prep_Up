      ...
      onPopInvokedWithResult: (didPop, result) async {
        ...
        final shouldPop = await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            title: Text(l10n.callExitConfirmTitle),
            content: Text(l10n.callExitConfirmMessage),
            ...
            actions: [
              ...
              FilledButton(
                ...
                child: Text(l10n.callExitConfirmAction),
              ),
            ],
          ),
        );
          ...
          children: [
            ...
            AnimatedBuilder(
              ...
              builder: (context, _) {
                ...
                final isListening =
                    state == InterviewConversationState.listening;
                final isProcessing =
...
class _RobotMiniPreview extends StatelessWidget {
  const _RobotMiniPreview({
          ...
          child: Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: accent.withValues(alpha: isSpeaking ? 0.42 : 0.30),
                    blurRadius: 15,
                    spreadRadius: 2,
                  ),
                ],
